...
FullStackProjectsComponent.prototypes = {
    isHidden: PropTypes.number
}

function FullStackProjectsComponent(props) {
  ...
  return (
    (props.isHidden === 3 ) ?  <div className="project-cards">
...
export default FullStackProjectsComponent;